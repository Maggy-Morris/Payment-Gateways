...
class StripeService {
  ...
  Future initPaymentSheet(
      {required Initpaymentsheetinputmodel initPaymentSheetInpitModel}) async {
    await Stripe.instance.initPaymentSheet(
        paymentSheetParameters: SetupPaymentSheetParameters(
            paymentIntentClientSecret: initPaymentSheetInpitModel.clientSecret,
            customerEphemeralKeySecret:
                initPaymentSheetInpitModel.ephemeralKeySecret,
            customerId: initPaymentSheetInpitModel.customerId,
            merchantDisplayName: "Maggy"));
  }
  ...
  Future makePayment(
    ...
    await initPaymentSheet(
        initPaymentSheetInpitModel: initPaymentSheetInputModel);
